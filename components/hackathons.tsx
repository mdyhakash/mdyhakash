...
import { hackathons, hackathonStats } from "@/lib/data";
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground mb-8 sm:mb-12 max-w-2xl text-sm sm:text-base">
            I love the energy and creativity of hackathons. Here are some of my
            favorite experiences building innovative solutions under pressure.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-6 mb-12 sm:mb-16">
            {hackathonStats.map((stat, index) => (
              ...
              >
                ...
                <div className="text-xs sm:text-sm text-muted-foreground font-mono text-balance">
                  {stat.label}
                </div>
              </motion.div>
            ))}
            ...
            <div className="space-y-8 sm:space-y-12">
              {hackathons.map((hackathon, index) => (
                ...
                >
                  ...
                  <div
                    className={`ml-12 sm:ml-20 md:ml-0 ${
